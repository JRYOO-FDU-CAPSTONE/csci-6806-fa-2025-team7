...
\\\noindent\textbf{2.1 Disk-head Time (DT) and Backend Load:}\\\indent DT measures the time the backend storage device spends servicing I/O requests. When the cache misses and forwards many reads to the backend, DT increases, which leads to queue buildup and slower response times. Previous work shows that static or poorly tuned
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure1.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure2.pdf}
  \vspace{-25pt}
...
\\\textbf{5.1 Disk-Head Time (DT) and Backend Load:\\}\indent 
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure3.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure4.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure6.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure7.pdf}
  \vspace{-25pt}
...
\indent Figure \ref{fig:1-8} summarizes the overall cache activity between different configurations, including chunk hits, chunk saves, evictions and also related metrics. This shows a wide
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure8.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure10.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure11.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure12.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure13.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{A9_figure14.pdf}
  \vspace{-25pt}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{appendix (1).pdf}
  \label{fig:1-15}
\end{figure}
